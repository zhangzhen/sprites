...
OBJS = DFinder.o SoftClip.o error.o DFinderHelper.o ChrRegion.o ChrRegionCluster.o Overlap.o Deletion.o library.o readgroup.o statisticscalculator.o $(BAMTOOLS_ROOT)/lib/libbamtools.a
