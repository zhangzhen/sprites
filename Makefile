...
OBJS = clip-sv.o DiscordantPairHandler.o Clip.o error.o Contig.o Locus.o Region.o SingleClipped.o LeftClipped.o RightClipped.o SingleClippedCluster.o LeftClippedCluster.o RightClippedCluster.o Window.o Interval.o Point.o IntervalCluster.o $(BAMTOOLS_ROOT)/lib/libbamtools.a
